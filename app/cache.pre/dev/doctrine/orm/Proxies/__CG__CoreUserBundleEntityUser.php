...
class User extends \Core\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'adFavorite', 'rating', 'level', 'notifications', '' . "\0" . 'Core\\UserBundle\\Entity\\User' . "\0" . 'dateCreated', 'userData', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function getAvatarImg()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAvatarImg', array());

        return parent::getAvatarImg();
    }
    ...
    public function getCoverImg()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCoverImg', array());
    ...
    public function addAdFavorite(\Core\AdBundle\Entity\Ad $adFavorite)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAdFavorite', array($adFavorite));

        return parent::addAdFavorite($adFavorite);
    }
    ...
    public function removeAdFavorite(\Core\AdBundle\Entity\Ad $adFavorite)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAdFavorite', array($adFavorite));

        return parent::removeAdFavorite($adFavorite);
    }
    ...
    public function getAdFavorite()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdFavorite', array());

        return parent::getAdFavorite();
    }
