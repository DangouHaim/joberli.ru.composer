...
class __TwigTemplate_840de5652b0f53b1647f90646a1bf04bf848fd84ddb09e25be89a3a546602b19 extends Twig_Template
{
    ...
    <div class=\"ad-short__content\">
            ...
            <div class=\"col-lg-12 ad-short__userinfo\">
                <div class=\"row\">
                    <div class=\"col-lg-6\">
                        ...
                        <a href=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_page", array("id" => $this->getAttribute($this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "userCreate", array()), "id", array()))), "html", null, true);
        echo "\" class=\"tooltips\" data-container=\"body\" title=\"Страница пользователя\">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "userCreate", array()), "username", array()), "html", null, true);
        echo "</a>
                    </div>
                    <div class=\"col-lg-6 text-right\">
                        <input type=\"hidden\" class=\"rating\" data-readonly value=\"";
        // line 11
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "ratingStars", array()), "html", null, true);
        echo "\"/>
                        (";
        // line 12
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "rating", array())), "html", null, true);
        echo ")
                    </div>
                </div>
            </div>
            <div class=\"col-lg-12\">
                <a href=\"";
        // line 17
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ad_show", array("slug" => $this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "slug", array()))), "html", null, true);
        echo "\" >
                ";
        // line 18
        if ($this->getAttribute($this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "photos", array()), "first", array(), "method")) {
            // line 19
            echo "                    <img style=\"width: 100%;\" src=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('liip_imagine')->filter($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "photos", array()), "first", array(), "method"), "photo", array()), "path", array()), "ad_cover_show"), "html", null, true);
        ...
        <div class=\"row ad-short__btn-bar\">
            <div class=\"col-lg-12 ad-short__btn-bar__content\">
                ";
        // line 33
        if (($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()) && $this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "isUserFavorite", array(0 => $this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array())), "method"))) {
            // line 34
        ...
        // line 42
        echo "                ";
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "userFavorite", array())) > 0)) {
            // line 43
            echo "                    <span class=\"likes\">";
            echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "userFavorite", array())), "html", null, true);
            echo "</span>
                ";
        }
        // line 45
