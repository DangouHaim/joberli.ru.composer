 ...
 */
class AdTask extends \Core\AdBundle\Entity\AdTask implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\AdBundle\\Entity\\AdTask' . "\0" . 'id', '' . "\0" . 'Core\\AdBundle\\Entity\\AdTask' . "\0" . 'user', '' . "\0" . 'Core\\AdBundle\\Entity\\AdTask' . "\0" . 'order', '' . "\0" . 'Core\\AdBundle\\Entity\\AdTask' . "\0" . 'startDate', '' . "\0" . 'Core\\AdBundle\\Entity\\AdTask' . "\0" . 'endDate', 'executDays', 'priority');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdTask $proxy) {
