 ...
 */
class AdSub extends \Core\AdBundle\Entity\AdSub implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\AdBundle\\Entity\\AdSub' . "\0" . 'id', '' . "\0" . 'Core\\AdBundle\\Entity\\AdSub' . "\0" . 'title', 'price', '' . "\0" . 'Core\\AdBundle\\Entity\\AdSub' . "\0" . 'date', 'executDays', '' . "\0" . 'Core\\AdBundle\\Entity\\AdSub' . "\0" . 'ad');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdSub $proxy) {
