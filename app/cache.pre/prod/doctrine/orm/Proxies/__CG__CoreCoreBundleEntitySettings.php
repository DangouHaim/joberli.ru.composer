 ...
 */
class Settings extends \Core\CoreBundle\Entity\Settings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\CoreBundle\\Entity\\Settings' . "\0" . 'id', '' . "\0" . 'Core\\CoreBundle\\Entity\\Settings' . "\0" . 'link', '' . "\0" . 'Core\\CoreBundle\\Entity\\Settings' . "\0" . 'title', '' . "\0" . 'Core\\CoreBundle\\Entity\\Settings' . "\0" . 'value');
        }
