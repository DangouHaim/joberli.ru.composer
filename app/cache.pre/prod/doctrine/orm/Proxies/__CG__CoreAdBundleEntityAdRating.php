 ...
 */
class AdRating extends \Core\AdBundle\Entity\AdRating implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\AdBundle\\Entity\\AdRating' . "\0" . 'id', '' . "\0" . 'Core\\AdBundle\\Entity\\AdRating' . "\0" . 'rate', 'comment', 'type', 'ad', 'user', 'order', '' . "\0" . 'Core\\AdBundle\\Entity\\AdRating' . "\0" . 'dateCreated', '' . "\0" . 'Core\\AdBundle\\Entity\\AdRating' . "\0" . 'dateUpdated');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdRating $proxy) {
