 ...
 */
class AdAttach extends \Core\AdBundle\Entity\AdAttach implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\AdBundle\\Entity\\AdAttach' . "\0" . 'id', '' . "\0" . 'Core\\AdBundle\\Entity\\AdAttach' . "\0" . 'title', '' . "\0" . 'Core\\AdBundle\\Entity\\AdAttach' . "\0" . 'date', '' . "\0" . 'Core\\AdBundle\\Entity\\AdAttach' . "\0" . 'photo', '' . "\0" . 'Core\\AdBundle\\Entity\\AdAttach' . "\0" . 'ad');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdAttach $proxy) {
