 ...
 */
class Transaction extends \Core\CoreBundle\Entity\Transaction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'type', 'note', 'status', 'user', 'notification', 'amount', '' . "\0" . 'Core\\CoreBundle\\Entity\\Transaction' . "\0" . 'dateCreated', 'balance');
        }
