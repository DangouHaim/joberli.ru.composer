 ...
 */
class NodeCategory extends \Core\NodeBundle\Entity\NodeCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\NodeBundle\\Entity\\NodeCategory' . "\0" . 'id', '' . "\0" . 'Core\\NodeBundle\\Entity\\NodeCategory' . "\0" . 'title', '' . "\0" . 'Core\\NodeBundle\\Entity\\NodeCategory' . "\0" . 'slug', '' . "\0" . 'Core\\NodeBundle\\Entity\\NodeCategory' . "\0" . 'userCreate', '' . "\0" . 'Core\\NodeBundle\\Entity\\NodeCategory' . "\0" . 'dateCreated', '' . "\0" . 'Core\\NodeBundle\\Entity\\NodeCategory' . "\0" . 'main');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NodeCategory $proxy) {
